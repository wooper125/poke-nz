...
#define P_SCATTERBUG_LINE_FORM_BREED   SPECIES_SCATTERBUG_GARDEN  // Choose the Scatterbug form all Vivillon/Spewpa/Scatterbug will breed into, basically aligning with the "location" of the player's game. Changed from fancy to garden
