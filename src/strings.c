...
const u8 gText_DexHoennTitle[] = _("ROA DEX"); // changed to ROA from HOENN
...
const u8 gText_DexHoennDescription[] = _("ROA region's POKéDEX"); // changed to ROA from HOENN
...
const u8 gText_DexHoenn[] = _("ROA"); // changed to ROA from HOENN
...
const u8 gText_Hoenn[] = _("ROA"); // changed to ROA from HOENN
