...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_KAWAKAWA_INLET] = {MAP_GROUP(MAP_KAWAKAWA_INLET), MAP_NUM(MAP_KAWAKAWA_INLET), HEAL_LOCATION_KAWAKAWA_INLET_MCHOUSE_2F},
    [MAPSEC_POHUTU_CITY] = {MAP_GROUP(MAP_POHUTU_CITY), MAP_NUM(MAP_POHUTU_CITY), HEAL_LOCATION_POHUTU_CITY},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_KAWAKAWA_INLET:
        return FlagGet(FLAG_VISITED_KAWAKAWA_INLET) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_POHUTU_CITY:
        return FlagGet(FLAG_VISITED_POHUTU_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
