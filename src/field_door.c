...
static const u8 sDoorAnimTiles_Kawakawa[] = INCBIN_U8("graphics/door_anims/kawakawa.4bpp");
static const u16 sDoorNullPalette50[16] = {};
static const u8 sDoorAnimTiles_Kawakawa_Player[] = INCBIN_U8("graphics/door_anims/kawakawa_player.4bpp");
...
static const u8 sDoorAnimPalettes_Kawakawa[] = {6, 6, 6, 6, 7, 7, 7, 7};
static const u8 sDoorAnimPalettes_Kawakawa_Player[] = {12, 12, 6, 6, 7, 7, 7, 7};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Kawakawa_Door_Kawakawa,                       DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Kawakawa, sDoorAnimPalettes_Kawakawa},
    {METATILE_Kawakawa_Door_Kawakawa_Player,                DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Kawakawa_Player, sDoorAnimPalettes_Kawakawa_Player},
    {},
};
