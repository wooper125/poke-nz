...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_OWN_TEMPO, ABILITY_UNAWARE },
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_VITAL_SPIRIT, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_SUREFIRE, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
