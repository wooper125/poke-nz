...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_LULLABY, ABILITY_RUN_AWAY, ABILITY_OWN_TEMPO },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 12, SPECIES_KRICKETUNE}),
    },
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LULLABY, ABILITY_TECHNICIAN, ABILITY_PUNK_ROCK },
        .bodyColor = BODY_COLOR_RED,
