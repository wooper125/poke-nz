...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_KEEN_EYE, ABILITY_FRIEND_GUARD },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_FURRET, CONDITIONS({IF_TIME, TIME_DAY})}),
    },
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_KEEN_EYE, ABILITY_FRIEND_GUARD },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 54 : 58,
        .evYield_HP = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_NOCTOWL, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .baseSpeed     = 120,
        .baseSpAttack  = 55,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 100 : 85,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 230,
