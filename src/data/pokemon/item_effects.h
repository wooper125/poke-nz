...
const u8 gItemEffect_SuperPotion[7] = {
    [4] = ITEM4_HEAL_HP,
    [6] = I_HEALTH_RECOVERY >= GEN_7 ? 120 : 50, // Amount of HP to recover
};
...
const u8 gItemEffect_SodaPop[7] = {
    [4] = ITEM4_HEAL_HP,
    [6] = I_HEALTH_RECOVERY >= GEN_7 ? 40 : 60, // Amount of HP to recover
};
...
const u8 gItemEffect_EnergyPowder[10] = {
    ...
    [6] = I_HEALTH_RECOVERY >= GEN_7 ? ITEM6_HEAL_HP_HALF : 50, // Amount of HP to recover
...
const u8 gItemEffect_EnergyRoot[10] = {
    [4] = ITEM4_HEAL_HP,
    [5] = ITEM5_FRIENDSHIP_ALL,
    [6] = I_HEALTH_RECOVERY >= GEN_7 ? ITEM6_HEAL_HP_FULL : 200, // Amount of HP to recover
